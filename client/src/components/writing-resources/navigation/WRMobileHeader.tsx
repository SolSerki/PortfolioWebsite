...
import { navItems } from './WRSidebar'

interface WRMobileHeaderProps {
...
export default function WRMobileHeader({
  activeSection,
  isSidebarOpen,
  onToggleSidebar,
  searchQuery,
  ...
  return (
    <div className="lg:hidden sticky top-0 z-30 bg-zinc-900/95 backdrop-blur-md border-b border-purple-500/20">
      ...
      {showSearch && (
        <div className="px-4 pb-3">
          <input
            ...
            className="w-full px-4 py-2 bg-zinc-800/50 border border-zinc-700 rounded-lg text-white placeholder:text-zinc-500 focus:outline-none focus:border-purple-500/50 text-sm"
            autoFocus
          />
        </div>
      )}
